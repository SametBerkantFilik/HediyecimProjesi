...
var app = {
    ...
    Posts: function() {
        ...
        /**
         * Bu yöntem, yüklenmesi gereken işlevlerin listesini içerir
         * "Yayınlar" nesnesi somutlaştırıldığında.
         *
         */
        this.init = function() {
        ...
        /**
         * Kullanıcı öğeleri sayfalandırmasını yükle.
         */
        this.get_user_items_pagination = function() {

            _this = this;

            /* Gizli form girişimizin boş olup olmadığını kontrol edin, yani sayfayı ilk kez görüntüleyemezsiniz. */
            if ($('form.post-list input').val()) {
                /* Önceki sayfa numarasını yüklemek için gizli form giriş değerini gönderin */
            ...
            /* Enter Key tetiklendiğinde arama yap */
            ...
            /* Tıklamaları Sıralama */
            $('body').on('click', '.table-post-list th', function(e) {
                e.preventDefault();
                var th_name = $(this).attr('id');

                if (th_name) {
                    /* "Etkin" sınıftaki tüm TH etiketlerini kaldırma */
                    if ($('.table-post-list th').removeClass('active')) {
                        /* Tıklanan TH etiketine "etkin" sınıfı ayarlayın */
        ...
        /**
         * AJAX kullanıcı öğeleri sayfalaması
         */
        ...
        /**
         * AJAX front-end öğelerinin sayfalandırması.
         */
        ...
        /**
         * Jquery form eklentisini kullanarak güncellenmiş verileri ajax aracılığıyla gönderin
         */
        ...
        /**
         * JQuery Form Eklentisi Kullanarak Ajax Üzerinden Yeni Ürün Verileri Gönderme
         */
        ...
        /**
         * Tek bir gönderinin silinmesini yönetir
         */
        ...
        /**
         * Görüntüyü silmek için bir AJAX isteği gönderir.
         */
        ...
        /**
         * Görüntüyü özellikli olarak ayarlamak için bir AJAX isteği gönderir.
         */
        ...
        /**
         * Görüntüleyici eklentisini başlat
         */
    ...
    Global: function() {
        ...
        /**
         * Bu yöntem, yüklenmesi gereken işlevlerin listesini içerir
         * "Global" nesne somutlaştırıldığında.
         *
         */
        this.init = function() {
            this.set_ckeditor();
